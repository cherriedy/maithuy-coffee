...
$sql = "SELECT MA_LOAISP 
            FROM $tb_lsp 
            ORDER BY MA_LOAISP DESC
            LIMIT 1";

$result = db_fetch_assoc(db_query($conn, $sql))['MA_LOAISP'];
                ...
                <div class="card-body">
                    ...
                    <div class="card-body__items">
                        ...
                        <div class="item-element">
                            ...
                            <input class="item-input text" type="text" name="name" placeholder="Tên loại sản phẩm">
                        </div>
                    </div>
                </div>
