...
<div class="table-wrapper">
    <div class="table-header">
        ...
        <a href="index.php?page=3" class="button">Thêm sản phẩm</a>
    </div>
        ...
        <table>
            ...
            ?>
                <tr>
                    ...
                    <td class="option">
                        <a href="index.php?page=4&&id=<?php echo $product_id; ?>"><i class='bx bxs-edit'></i></a>
                        <a href="index.php?page=5&&id=<?php echo $product_id; ?>"><i class='bx bx-trash'></i></a>
                    </td>
                </tr>
            <?php
            }
