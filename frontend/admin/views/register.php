<div class="outer-wrapper">
    <div class="inner-wrapper">
        ...
        <form action="./functions/register/create.php" method="post" class="signup-form-wrapper">
                ...
                <div class="stage-no-1-content">
                    ...
                    <div class="button-wrapper">
                        ...
                        <div class="gender-selection">
                            ...
                            <label for="male"><input type="radio" name="gender" id="male" value="0" required>Nam</label>
                ...
                <div class="stage-no-2-content">
                    ...
                    <div class="button-wrapper">
                        ...
                        <div class="text-fields confirm-password">
                            ...
                            <input type="password" name="confirm-password" id="confirm-password" placeholder="Nhập mật khẩu"
                                required>
                        </div>
                    </div>
                    <div class="pagination-btn">
                ...
                <div class="stage-no-3-content">
                    <div class="button-wrapper">
                        <div class="text-fields address">
                            ...
                            <input type="text" name="address" id="address" placeholder="1 Đ.Cộng Hòa, Tân Bình" required
                                autocomplete="on">
                        </div>
...
<script>
    ...
    function stage1to2() {
        ...
        signupContent3.style.display = "none";
        document.querySelector(".stage-no-1").style.backgroundColor = "#002D3B";
    ...
    function stage2to1() {
        ...
        document.querySelector(".stage-no-1").style.color = "#002D3B";
    }
    ...
    function stage2to3() {
        ...
        signupContent1.style.display = "none";
        signupContent2.style.display = "none";
        document.querySelector(".stage-no-2").style.backgroundColor = "#002D3B";
    ...
    function stage3to2() {
        ...
        document.querySelector(".stage-no-2").style.color = "#002D3B";
    }
</script>