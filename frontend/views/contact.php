<section id="contact">
    ...
    <div class="contact-box">
        <div class="contact-box-left">
            ...
            <form method="post" action="./backend/functions/public/contact.php">
                <div class="input-row">
                    ...
                    <div class="input-group">
                        <label>Email</label>
                        <input type="text" placeholder="lienhe@maithuycoffee.vn" name="email">
                    </div>

                    <div class="input-group">
                        <label>Địa chỉ</label>
                        <input type="text" placeholder="Việt Nam" name="address">
                    </div>
                </div>
        ...
        <div class="contact-box-right">
            ...
            <h3 style="font-size: 30px;">MAITHUY COFFEE</h3>
            <table>
                <tr>
                    <td><i class="fa-solid fa-envelope"></i>Email</td>
                    <td>lienhe@maithuycoffee.vn</td>
                </tr>
    ...
    <section class="map">
        <h1 style="text-align: center;">Bản đồ vị trí</h1>
        <p style="text-align: center;">Xác định vị trí cửa hàng chúng tôi nhanh chóng</p>
        <iframe
