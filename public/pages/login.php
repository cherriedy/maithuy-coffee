<div class="outer-wrapper">
    <div class="inner-wrapper">
        ...
        <div class="login-link">
            ...
            <p class="side-small-pragraph">Để trải nghiệm dịch vụ mua hàng nhanh chóng và tiện lợi ngay hôm nay !</p>
            <a href="index.php?page=6" # class="login-btn">Đăng kí ngay</a>
        </div>
