        ...
        <div class="inner-wrapper">
            ...
            <div class="login-link register">
                ...
                <div class="logo">
                    ...
                    <span class="text">MAITHUY</span>
                </div>
                <!-- Login text section -->
                <p class="side-big-heading">Đã là thành viên ?</p>
                <p class="side-small-pragraph">Để theo dõi đơn hàng hãy nhanh chóng đăng nhập vào tài khoản cá nhân của bạn</p>
                <a href="index.php?page=5" # class="login-btn">Đăng nhập</a>
            </div>
